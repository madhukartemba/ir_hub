...
class AutoModeAddDevice : public Screen {
   private:
    enum class State {
   ...
   public:
    AutoModeAddDevice() : currentState(State::READY_TO_RECORD_FIRST), hasFirstCode(false) {}

    void onEnter() override {
        LOG_DEBUG("AutoModeAddDevice onEnter");
        ...
        button.setClickCallback([this]() {
            LOG_DEBUG("AutoModeAddDevice onButtonClick");
        ...
        button.setLongPressCallback([this]() {
            LOG_DEBUG("AutoModeAddDevice onButtonLongPress");
    ...
    void onExit() override {
        LOG_DEBUG("AutoModeAddDevice onExit");
   ...
   private:
    ...
    void drawReadyToRecordFirst() {
        ...
        display.printCentered("Auto Mode Device", 0);
